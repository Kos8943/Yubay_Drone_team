    ...
    public partial class Fixed : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataTable dt = DBbase.ReadFixed(out TotalSize, SearchField, SearchKeyWord, Convert.ToInt32(currentPage));
        ...
        protected void repInvoice_ItemCommand1(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                //準備轉跳至修改無人機維修紀錄頁面,並將SID值用URL帶過去
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect($"Fixed.aspx?Page={currentPage}&WantSearch={KeyWord}&SearchField={SearchField}");
            }
            else
            {
