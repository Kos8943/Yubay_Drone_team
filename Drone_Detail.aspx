                ...
                <asp:Repeater ID="repInvoice" runat="server" OnItemCommand="repInvoice_ItemCommand1">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><asp:Button CssClass="btn btn-outline-danger btn-sm BtnDel" runat="server" Text="退役" CommandName="DeleItem" CommandArgument='<%# Eval("Sid")+","+ Eval("Drone_ID") %>' OnClientClick="javascript:return confirm('退役後將無法再建立相同無人機,確定將此無人機退役?')"/></td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
