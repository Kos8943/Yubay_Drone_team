                ...
                <asp:Repeater ID="repInvoice" runat="server" OnItemCommand="repInvoice_ItemCommand1">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><asp:Button CssClass="btn btn-outline-danger btn-sm BtnDel" runat="server" Text="刪除" CommandName="DeleItem" CommandArgument='<%# Eval("Sid")+","+ Eval("Drone_ID") %>' OnClientClick="javascript:return confirm('確定刪除?')"/></td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
